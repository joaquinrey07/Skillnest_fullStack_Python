'''
Datos primitivos:
Estos son los elementos basicos de un lenguaje, la mayoria
de los lenguaje comparten estos en comun
'''
...
perro[2] = "comida de perro" #ERROR: Las tuplas no pueden
#ser modificadas (TypeError: 'tuple' object does not support item assignment)
